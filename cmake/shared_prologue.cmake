...
function(guarantee_clap_wrapper_shared)
    ...
    if (TARGET fmt::fmt)
        message(STATUS "clap-wrapper: fmt::fmt is an existing target; using that for clap-wrapper")
        target_link_libraries(clap-wrapper-shared-detail PUBLIC fmt::fmt)
    elseif (TARGET fmt-header-only)
        ...
        message(STATUS "clap-wrapper: using included fmt library since `fmt::fmt`/`fmt-header-only` not available")
